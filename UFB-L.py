...
negative_classes = ["kitchen_&_housewares",'apparel', "baby","beauty","grocery","music","outdoor_living",'sports_&_outdoors', 'jewelry_&_watches',"magazines"]

not_in_negative_train_classes=['camera_&_photo', 'toys_&_games', 'gourmet_food', 'video', 'cell_phones_&_service', 'health_&_personal_care','dvd', "books","software","electronics"]
